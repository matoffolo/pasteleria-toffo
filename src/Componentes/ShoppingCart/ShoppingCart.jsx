      ...
      <div className="container mx-auto mt-10">
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10  ">
            ...
            {cart.length > 0 &&
              cart.map((product) => (
                <div
                  key={product.id}
                  className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-4"
                >
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      <span className="text-sm">
                        <Link
                          to={`/item/${product.id}`}
                          className="font-semibold no-underline text-gray-700 hover:text-gray-900"
                        >
                          {product.nombre}
                        </Link>
                      </span>
            ...
            <Link to="/" className="flex btn btn-outline-dark py-1 mt-4 mt-10">
              {" "}
          ...
          <div id="summary" className="w-1/4 px-8 py-12">
            <h1 className="font-semibold text-2xl border-b pb-8">Orden</h1>
